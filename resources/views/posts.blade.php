      ...
      @foreach ($posts as $post)
        <div class="col-md-4 mb-3">
          <div class="card-deck">
            ...
            @else
              <img src="https://source.unsplash.com/500x400?{{ $post->category->name }}" class="card-img-top rounded-circle" alt="{{ $post->category->name }}">
            @endif
            ...
            <div class="card-body">
              ...
              <p class="card-text"><i class="bi bi-gear"> </i>{{ $post->excerpt }} <br>
